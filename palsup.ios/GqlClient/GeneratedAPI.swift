...
public struct UserInput: GraphQLMapConvertible {
  ...
  public var name: NameInput {
    get {
      return graphQLMap["name"] as! NameInput
    }
    set {
...
public struct LocationInput: GraphQLMapConvertible {
  ...
  public init(address: Swift.Optional<String?> = nil, city: Swift.Optional<String?> = nil, state: Swift.Optional<String?> = nil, coordinates: Swift.Optional<CoordinatesInput?> = nil) {
    graphQLMap = ["address": address, "city": city, "state": state, "coordinates": coordinates]
  }
...
public struct CoordinatesInput: GraphQLMapConvertible {
  ...
  public init(latitude: Swift.Optional<String?> = nil, longitude: Swift.Optional<String?> = nil, radius: Swift.Optional<Int?> = nil) {
    graphQLMap = ["latitude": latitude, "longitude": longitude, "radius": radius]
  }

  public var latitude: Swift.Optional<String?> {
    get {
      return graphQLMap["latitude"] as! Swift.Optional<String?>
    }
    set {
  ...
  public var longitude: Swift.Optional<String?> {
    get {
      return graphQLMap["longitude"] as! Swift.Optional<String?>
    }
    set {
...
public final class CreateUserMutation: GraphQLMutation {
  ...
  public var queryDocument: String { return operationDefinition.appending(NameFields.fragmentDefinition).appending(LocationFields.fragmentDefinition).appending(PictureFields.fragmentDefinition) }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateUser: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: Name, gender: Gender, registrationDate: String, dob: String, email: String? = nil, cell: String? = nil, location: Location? = nil, absolutePicture: AbsolutePicture? = nil) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "name": name.resultMap, "gender": gender, "registrationDate": registrationDate, "dob": dob, "email": email, "cell": cell, "location": location.flatMap { (value: Location) -> ResultMap in value.resultMap }, "absolutePicture": absolutePicture.flatMap { (value: AbsolutePicture) -> ResultMap in value.resultMap }])
      }
...
public struct LocationFields: GraphQLFragment {
  ...
  public init(address: String? = nil, city: String? = nil, state: String? = nil, coordinates: Coordinate? = nil) {
    self.init(unsafeResultMap: ["__typename": "Location", "address": address, "city": city, "state": state, "coordinates": coordinates.flatMap { (value: Coordinate) -> ResultMap in value.resultMap }])
  }
  ...
  public struct Coordinate: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      ...
      GraphQLField("raidus", type: .scalar(Int.self)),
    ]
    ...
    public init(latitude: String? = nil, longitude: String? = nil, raidus: Int? = nil) {
      self.init(unsafeResultMap: ["__typename": "Coordinates", "latitude": latitude, "longitude": longitude, "raidus": raidus])
    }
    ...
    public var raidus: Int? {
      get {
        return resultMap["raidus"] as? Int
      }
      set {
        resultMap.updateValue(newValue, forKey: "raidus")
      }
    }
  }
}
